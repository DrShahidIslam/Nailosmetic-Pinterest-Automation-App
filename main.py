...
CTA_OPTIONS = {
    "nails": [
        "Tap to find the exact polish",
        "Click here for the tutorial",
        "Get the full step-by-step",
        "Click for the secret technique",
        "Tap to see how it's done",
        "Find the exact shades here",
        "Click to get this look",
    ],
    "hair_beauty": [
        "Tap for the full tutorial",
        "Click to see the secret",
        "Get the step-by-step guide",
        "Tap to find the products used",
        "Click here to get this look",
        "Find out how to recreate this",
    ],
    "home_garden": [
        "Tap for the before & after",
        "Click to see the full makeover",
        "Get the exact product links",
        "Tap to see how we did it",
        "Click for the full room tour",
        "Find out the total cost here",
        "Tap for the step-by-step guide",
        "Click to shop this exact look",
        "Get the DIY instructions here",
    ],
    "fashion_style": [
        "Tap to shop this exact outfit",
        "Click here for the links",
        "Get the exact pieces here",
        "Tap to find out where it's from",
        "Click to shop the look on a budget",
        "Find the exact dupes here",
    ],
}
...
{{
  ...
  "overlay_text": "A massive, urgent 3-6 word CLICK-BAIT hook for the image overlay. DO NOT describe the image. FORCE them to click (e.g., 'Tap For The Exact Polish', 'The Secret To This Look', 'Why This Lasts 4 Weeks', 'Click To See The Tutorial').",
